# Anthale TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/anthale.svg?label=npm%20(stable)>)](https://npmjs.org/package/anthale) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/anthale)

This library provides convenient access to the Anthale REST API from server-side TypeScript or JavaScript.

The REST API documentation can be found on [anthale.com](https://anthale.com/support). The full API of this library can be found in [api.md](api.md).
...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=anthale-mcp&config=eyJuYW1lIjoiYW50aGFsZS1tY3AiLCJ0cmFuc3BvcnQiOiJzc2UiLCJ1cmwiOiJodHRwczovL2FudGhhbGUuc3RsbWNwLmNvbS9zc2UifQ)
[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22anthale-mcp%22%2C%22type%22%3A%22sse%22%2C%22url%22%3A%22https%3A%2F%2Fanthale.stlmcp.com%2Fsse%22%7D)
...
1. Via the `ANTHALE_LOG` environment variable
...
const client = new Anthale({
  logger: logger.child({ name: 'Anthale' }),
...
const client = new Anthale({ fetch });
```
...
```ts
import Anthale from 'npm:anthale';
